...
class OccupierController extends Controller
{
    public function index(Request $request)
    {
        ...
        return response()->json($occupiers);
    }
    ...
    {
        return response()->json($occupier->load(['housingUnit', 'housingUnit.housingType', 'notes.user']));
    }
    ...
    public function moveOut(Request $request, Occupier $occupier)
    {
        ...
        return response()->json([
            'message' => 'Occupier moved out successfully',
            'occupier' => $occupier->load('housingUnit'),
        ]);
    }
}